...
const XPTN = '👾GUS BOT👾'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/gusdin_'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6281997826183'; // Nomor whatsapplu cok
...
const xp = require("./lib/gus.js");
const donate = require("./lib/donate.js");
const info = require("./lib/info.js");
const xp1 = require("./lib/gus1.js");
const xp2 = require("./lib/gus2.js");
const xp3 = require("./lib/gus3.js");
const xp4 = require("./lib/gus4.js");
const xp5 = require("./lib/gus5.js");
const xp6 = require("./lib/gus6.js");
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6281997826183:+62 819-9782-6183\n' // WhatsApp ID + phone number
            + 'END:VCARD'
//
const
{
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @gusdin_`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by @gusdin_`)
})
...
conn.sendMessage(id, 'Owner XP-TN wa.me/+6281997826183' ,MessageType.text);
}
else if (text == 'Gusdin'){
conn.sendMessage(id, 'Aku BOT nya GusDin' ,MessageType.text);
}
else if (text == 'Mita'){
conn.sendMessage(id, 'pacar owner ihh' ,MessageType.text);
}
else if (text == 'bangsat'){
conn.sendMessage(id, 'toxic mulu bangsat' ,MessageType.text);
}
...
conn.sendMessage(id, 'babi? lu yg babi, anjing!' ,MessageType.text);
}
else if (text == 'Bacot'){
...
conn.sendMessage(id, ' *COMMAND PREMIUM CHAT WA https://wa.me/6281997826183* ' ,MessageType.text);
}
else if (text == 'Woi'){
conn.sendMessage(id, 'Ya?, Ketik #help/.info/.donasi Contoh #help' ,MessageType.text);
}
...
conn.sendMessage(id, {displayname: "Gus Din", vcard: vcard}, MessageType.contact)
...
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾GUS BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/_gusdin_' ,MessageType.text);
}
else if (text == '.tools1'){
conn.sendMessage(id, ' _🗣️Thanks Telah Menggunakan BOT *👾GUS BOT👾* , Follow Instagram Mimin Yah😻 : https://instagram.com/_gusdin_' ,MessageType.text);
}
...
conn.sendMessage(id, '➡ Group1 : \n➡ Group2 : ' ,MessageType.text);
}
     if (messageType == 'imageMessage')
   {
       let caption = imageMessage.caption.toLocaleLowerCase()
